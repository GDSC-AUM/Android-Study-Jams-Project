...
import com.example.asj_project_main.databinding.ActivityEntertainmentMenuBinding
import com.example.asj_project_main.healthcare.*

class EntertainmentMenuActivity : AppCompatActivity(), EntertainmentClickListener {
    private lateinit var binding: ActivityEntertainmentMenuBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityEntertainmentMenuBinding.inflate(layoutInflater)
        setContentView(binding.root)
        healthcareinfo()
        val mainact = this
        binding.myView.apply{
            layoutManager = LinearLayoutManager(applicationContext)
            adapter = EntertainmentAdapter(entertainmentList,mainact)
        }
    }

    override fun onClick(entertainment: entertainment) {
        val intent = Intent(applicationContext, EntertainmentDetailActivity::class.java)
        intent.putExtra(ENTERTAINMENT_EXTRA,entertainment.id)
        startActivity(intent)
    }

    private fun healthcareinfo() {
        val health1 = entertainment(
            R.drawable.ic_exercise,
            "Exercise Tips",
            "Trying Something!"
        )
        entertainmentList.add(health1)

        val health2 = entertainment(
            R.drawable.ic_diet,
        ...
        entertainmentList.add(health2)
        val health3 = entertainment(
        ...
        entertainmentList.add(health3)
        val health4 = entertainment(
        ...
        entertainmentList.add(health4)
        val health5 = entertainment(
        ...
        entertainmentList.add(health5)
        val health6 = entertainment(
