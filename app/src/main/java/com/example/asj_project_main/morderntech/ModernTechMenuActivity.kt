...
import com.example.asj_project_main.databinding.ActivityModernTechMenuBinding
import com.example.asj_project_main.healthcare.*

class ModernTechMenuActivity : AppCompatActivity(), modernTechClickListener {
    private lateinit var binding: ActivityModernTechMenuBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityModernTechMenuBinding.inflate(layoutInflater)
        setContentView(binding.root)
        healthcareinfo()
        val mainact = this
        binding.myView.apply{
            layoutManager = LinearLayoutManager(applicationContext)
            adapter = MTAdapter(modernTechList1,mainact)
        }
    }

    override fun onClick(modernTech: modernTech) {
        val intent = Intent(applicationContext, ModernTechDetailActivity::class.java)
        intent.putExtra(MT_EXTRA,modernTech.id)
        startActivity(intent)
    }

    private fun healthcareinfo() {
        val health1 = modernTech(
        ...
        modernTechList1.add(health1)

        val health2 = modernTech(
            R.drawable.ic_diet,
        ...
        modernTechList1.add(health2)
        val health3 = modernTech(
        ...
        modernTechList1.add(health3)
        val health4 = modernTech(
        ...
        modernTechList1.add(health4)
        val health5 = modernTech(
        ...
        modernTechList1.add(health5)
        val health6 = modernTech(
